...
class ModuleController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('S2ModuleBundle:Module:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('S2ModuleBundle:Module')->find($id);
        ...
        return $this->render('S2ModuleBundle:Module:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('S2ModuleBundle:Module:edit.html.twig', array(
            'entity'      => $entity,
